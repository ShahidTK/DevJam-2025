        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              <button onClick={() => setDarkMode(!darkMode)} className="text-gray-300 hover:text-white transition-colors duration-200">
              ...
              <button onClick={handleLogout} className="text-white px-4 py-2 rounded bg-green-600 hover:bg-green-700 transition-colors duration-200">
                Log Out
              </button>
            </div>
          </div>
